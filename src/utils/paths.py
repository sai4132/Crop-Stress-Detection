...
SPLITS_DIR = PROJECT_ROOT/paths_config["SPLITS"]["ROOT"]
ALL_LABELS_PATH = SPLITS_DIR/paths_config["SPLITS"]["ALL"]
TRAIN_LABELS_PATH = SPLITS_DIR/paths_config["SPLITS"]["TRAIN"]
TEST_LABELS_PATH = SPLITS_DIR/paths_config["SPLITS"]["TEST"]
VAL_LABELS_PATH = SPLITS_DIR/paths_config["SPLITS"]["VAL"]